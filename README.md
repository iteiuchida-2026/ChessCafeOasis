...
|------|------|
| **タイトル** | ChessCafeOasis|
| **ゲーム紹介（30秒）** | ボードゲームのチェスを3Dで作成しました|
| **アピールポイント** | 設計段階から計画的に制作を進めました|
| **頑張った点・工夫した点** | チェスセットをBlenderで0から作成し、プログラミングではコードが無秩序にならないように意識しました|
| **苦労した点・エラーと解決** | BlenderとUnityのデータ間同期ができない部分で修正作業が多くあり、ネット記事を参考に修正しました|
| **操作方法** | マウス左クリックで駒を選択、配置（タッチ）|
| **今後追加したいこと** | ネット対戦機能など|
